...
extern PROTOBUF_INTERNAL_EXPORT_grSim_5fRobotstatus_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Robot_Status_grSim_5fRobotstatus_2eproto;
...
static void InitDefaultsscc_info_Robot_Status_grSim_5fRobotstatus_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Robot_Status_grSim_5fRobotstatus_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Robot_Status_grSim_5fRobotstatus_2eproto}, {}};

static void InitDefaultsscc_info_Robots_Status_grSim_5fRobotstatus_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Robots_Status_grSim_5fRobotstatus_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Robots_Status_grSim_5fRobotstatus_2eproto}, {
      &scc_info_Robot_Status_grSim_5fRobotstatus_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_grSim_5fRobotstatus_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_grSim_5fRobotstatus_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_grSim_5fRobotstatus_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_grSim_5fRobotstatus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_grSim_5fRobotstatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_grSim_5fRobotstatus_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_grSim_5fRobotstatus_2eproto_sccs[2] = {
  &scc_info_Robot_Status_grSim_5fRobotstatus_2eproto.base,
  &scc_info_Robots_Status_grSim_5fRobotstatus_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_grSim_5fRobotstatus_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_grSim_5fRobotstatus_2eproto = {
  false, false, descriptor_table_protodef_grSim_5fRobotstatus_2eproto, "grSim_Robotstatus.proto", 170,
  &descriptor_table_grSim_5fRobotstatus_2eproto_once, descriptor_table_grSim_5fRobotstatus_2eproto_sccs, descriptor_table_grSim_5fRobotstatus_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_grSim_5fRobotstatus_2eproto::offsets,
  file_level_metadata_grSim_5fRobotstatus_2eproto, 2, file_level_enum_descriptors_grSim_5fRobotstatus_2eproto, file_level_service_descriptors_grSim_5fRobotstatus_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_grSim_5fRobotstatus_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_grSim_5fRobotstatus_2eproto)), true);
...
void Robots_Status::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Robots_Status_grSim_5fRobotstatus_2eproto.base);
}
...
const Robot_Status& Robot_Status::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Robot_Status_grSim_5fRobotstatus_2eproto.base);
  return *internal_default_instance();
}
